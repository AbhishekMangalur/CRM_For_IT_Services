...
function SolutionCombobox({
  ...
  return (
    <div className="space-y-2">
      <Label htmlFor="estimation_solution_search">
        Solution *
      </Label>
      ...
      <div className="relative">
        ...
        <Input
          ...
          aria-controls="estimation_solution_search-options"
        ...
        {isOpen && (
          <div
            id="estimation_solution_search-options"
            role="listbox"
